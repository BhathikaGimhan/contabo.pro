...
@section('content')
    ...
    <div class="container-fluid container-bg position-relative pb-4">
            ...
            <div class="row pb-3">
                <div class="col-md-12">
                    <div class="text-center" id="header-title">
                        <br><br><br>
                        <h1 class="font-bold heading-text">Staff Gallery</h1>
                        <p class="mt-4 sub-title">Unveiling Excellence: Celebrating Trinity's Inspirational Staff</p>
                    </div>
                </div>
                <div class="row mt-2 container">
                    <div class="col">
                        <p class="text-center" id="blue-text">Welcome to the Staff Gallery, an enchanting compilation of images and write-ups that shine a spotlight on the exceptional teachers and masters of Trinity College.
                            Delve into their stories and celebrate the profound impact they have made on the institution and its students. 
                            With just a few clicks, you can immerse yourself in the invaluable contributions of these remarkable individuals.
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div>
                    <div class="row">
                        ...
                        <div class="col-md-3 d-flex justify-content-center">
                            <div>
                                <div>
                                    <img class="principal-img" src="https://test.contabo.pro/public/assets/images/staff/image12.png" >
                                </div>
                                <div class="pt-2">
                                    <p class="principal-name">Mr. L. S. Danthanarayana</p>
                                    <p class="principal-name">1976 - 2001</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
            ...
            <div class="row pb-5">
                <div class="col-md-1 d-flex justify-content-center mt-4">
                    <div class="img-principal">
                        <img src="https://test.contabo.pro/public/assets/images/staff/image12.png" class="img-principal  active" >
                    </div>
                </div>
                <div class="col-md-1 d-flex justify-content-center mt-4">
                    <div class="img-principal">
                        <img src="https://test.contabo.pro/public/assets/images/staff/image2.png" class="img-principal" >
                    </div>
                </div>
                <div class="col-md-1 d-flex justify-content-center mt-4">
                    <div class="img-principal">
                        <img src="https://test.contabo.pro/public/assets/images/staff/image3.png" class="img-principal" >
                    </div>
                </div>
                <div class="col-md-1 d-flex justify-content-center mt-4">
                    <div class="img-principal">
                        <img src="https://test.contabo.pro/public/assets/images/staff/image4.png" class="img-principal" >        
                    </div>
                </div>
                <div class="col-md-1 d-flex justify-content-center mt-4">
                    <div class="img-principal">
                        <img src="https://test.contabo.pro/public/assets/images/staff/image5.png" class="img-principal" >        
                    </div>
                </div>
                <div class="col-md-1 d-flex justify-content-center mt-4">
                    <div class="img-principal">
                        <img src="https://test.contabo.pro/public/assets/images/staff/image6.png" class="img-principal" >        
                    </div>
                </div>
                <div class="col-md-1 d-flex justify-content-center mt-4">
                    <div class="img-principal">
                        <img src="https://test.contabo.pro/public/assets/images/staff/image7.png" class="img-principal" >
                    </div>
                </div>
                <div class="col-md-1 d-flex justify-content-center mt-4">
                    <div class="img-principal">
                        <img src="https://test.contabo.pro/public/assets/images/staff/image8.png" class="img-principal" >        
                    </div>
                </div>
                <div class="col-md-1 d-flex justify-content-center mt-4">
                    <div class="img-principal">
                        <img src="https://test.contabo.pro/public/assets/images/staff/image9.png" class="img-principal" >        
                    </div>
                </div>
                <div class="col-md-1 d-flex justify-content-center mt-4">
                    <div class="img-principal">
                        <img src="https://test.contabo.pro/public/assets/images/staff/image10.png" class="img-principal" >
                    </div>
                </div>
                <div class="col-md-1 d-flex justify-content-center mt-4">
                    <div class="img-principal">
                        <img src="https://test.contabo.pro/public/assets/images/staff/image11.png" class="img-principal" >
                    </div>
                </div>
                <div class="col-md-1 d-flex justify-content-center mt-4">
                    <div class="img-principal">
                        <img src="https://test.contabo.pro/public/assets/images/staff/image12.png" class="img-principal" >        
                    </div>
                </div>
                <div class="col-md-1 d-flex justify-content-center mt-4">
                    <div class="img-principal">
        ...
        <!--div class="container staff-data-container pb-5">
            {{-- staff list  --}}
        </div-->
    </div>
...
{{--                @include('modals.principle-view')--}}
    ...
    @include('modals.share-modal-staff')
    @include('modals.collection-modal-staff')
    @include('modals.info-modal-staff')
