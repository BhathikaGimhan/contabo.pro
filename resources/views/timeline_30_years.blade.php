...
@section('content')
    ...
    <section class="back container-fluid timeline">
        <div class="sec-content container">
            ...
            <div class="overlay container">
                ...
                <div class="row nav-head bg-red">
                    <div class="col-lg-4 col-md-12 color_w text-center d-flex align-items-center justify-content-start year-range">
                    ...
                    @php
                        ...
                        $next_one = $first_year + 15;

                        $next_year_range = "$first_year-$next_one";
                    ...
                    <div class="col-lg-4 col-md-12 color_w d-flex align-items-center justify-content-center"
                        ...
                        @else
                            <a href="{{ route('timeline.filter-data', $next_year_range) }}">
                                <i class="fa-solid fa-circle-plus zoom-icons"></i>
                            </a>
                        @endif
                ...
                <div style="margin-top: 1px;">
                    <div class="row text-center border-1">
                        ...
                        <div class="col slide-container time-swiper swiper">
                            <div class="swiper-wrapper">
                                @foreach ($year_30_array as $year)
                                    <div class="year-section-black swiper-slide">
                                        <div style="color: white !important">
                                            <h5 class="timeline-year">{{ $year }}</h5>
                                        </div>
                                    </div>
                                @endforeach
                            </div>
                    ...
                    <div class="row timeline-data-container">
                        <div class="col-md-1 px-0 bottom-empty-space"></div>
                        <div class="col slide-container time-cont-swiper swiper">
                            <div class="swiper-wrapper items">
                                @foreach ($display_data as $data)
                                    <div class="col-md-2 history-column swiper-slide">
                                        @foreach ($data as $item)
                                            <div class="history-item text-center 30-year" data-doc="{{ $item->id() }}">

                                                <div class="top-bar-date">
                                                    <h6 class="h2text">{{ $item->data()['year'] }}
                                                ...
                                                <h2 class="h2text_w">{!! $item->data()['title'] !!}</h2>
                                            </div>
                                        @endforeach
                        ...
                        <div class="swiper-button-next swiper-navBtn button-next bottom-slide-btn">
                            <i class="fa-solid fa-caret-right slider-icon"></i>
                        </div>
                        <div class="swiper-button-prev swiper-navBtn button-prev bottom-slide-btn">
